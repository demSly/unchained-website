  ...
  <PageLayout title={partnerProgram.meta_title} metaDescription={partnerProgram.meta_description}>
    <div className="wrap wrap--narrow mv7">
      <section id="partnerProgram" className="section">
        ...
        <p>Join a partnership that lifts your digital commerce projects to the next level.</p>
        <p>The Unchained Enterprise Partners Program is suited for agencies who
        ...
        <ul>
          <li>Promoting partnership in press releases, social media, blog posts or mailings</li>
          <li>Listing as Partner on unchained.shop & logo rights</li>
          <li>Guaranteed conference speech seats</li>
          <li>Forward incoming project leads</li>
        </ul>

        <h3>Engineering</h3>
        <ul>
          <li>Access to unchained engineers</li>
          <li>Feature Request Prioritization for Unchained core modules</li>
